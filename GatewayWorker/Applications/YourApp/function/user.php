...
class user
{
    ...
    public  function userinfo($id){
       ...
       // if(strpos($avatar,'http')!==false)
        ...
        $data= array('id'=>$user['id'],'nickname'=>$nickname,'avatar'=>$avatar,'money'=>$user['money'],'province'=>$user['province'],'city'=>$user['city'],'isvip'=>$user['isvip'],'status'=>$user['status'],'backlist'=>$user['backlist']);
