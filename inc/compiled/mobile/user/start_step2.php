...
<div class='line'>
<span  class='title'><span class='must'>*</span>开始打球：</span>
...
<input type='submit' class='btn01' id='click_next' value='保存并进入下一步'  onclick="return click_sub(<?php echo $step; ?>,<?php echo $user['group']; ?>)"; >
<?php } else { ?>
