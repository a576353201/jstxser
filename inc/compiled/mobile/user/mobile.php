...
<div class="header">
    ...
    <span class="title">
           <?php if($user['mobile'] && $_GET['type']!=2){?>
...
<ul class="profile" >
    ...
    <input type="button" value="更换手机号" class="button1" onclick="return click_mobile();">
    <?php } else { ?>

    <input type="button" value="确认绑定" class="button1" onclick="return click_mobile();">
    <?php }?>
