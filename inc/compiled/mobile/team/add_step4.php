...
<iframe src='../upload_mobile.php?fileid=file_add1&img=<?php echo $file['file1']; ?>&iframeid=upload_src1'  id='upload_src1'  style='width:100%;height:100px;'marginwidth="0px" frameborder="0" scrolling="no" ></iframe>
</div>
...
<iframe src='../upload_mobile.php?fileid=file_add2&img=<?php echo $file['file2']; ?>&iframeid=upload_src2'  id='upload_src2'  style='width:100%;height:100px;'marginwidth="0px" frameborder="0" scrolling="no" ></iframe>
</div>
...
<iframe src='../upload_mobile.php?fileid=file_add3&img=<?php echo $file['file3']; ?>&iframeid=upload_src3'  id='upload_src3'  style='width:100%;height:100px;'marginwidth="0px" frameborder="0" scrolling="no" ></iframe>
</div>
