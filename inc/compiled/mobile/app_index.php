...
<style>
    ...
    .top-title {max-width:640px;margin-top: 10px;background-color: #ffffff;}
    .common-title {width:1170px;padding:0 0 10px 10px;font-size:16px;font-weight:700;color: #000000;}
    .top-title ul {overflow: hidden;}
    .top-title ul li {padding:25px 10px;border:1px solid #dddddd;margin: 10px 5px;}
    ...
    .table-ewm tr td{padding-left: 0 !important;width: 120px;padding: 15px 0;}
...
<div class="cst-content" style="padding:1px 0;background-color:rgba(255,255,255,0);">
    <div class="container index-body" style="padding-top: 15px; padding-bottom: 15px;">
        <div class="index-app-box">

            <div class="index-app-box1" style=" background-color: #ffffff;max-width:640px;padding: 10px;">
