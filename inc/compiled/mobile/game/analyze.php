    ...
    <div class="container cst-mainbody" style="padding:0;">
        ...
        <div class="lg-analysize-select">
            ...
            <div class="lg-analysize-table">
                <div class="fx-panel-box2" style=""><ul><li><i class="iconfont icon-yingyongjianjie"></i><?php echo $gameinfo['title']; ?>
                    <a class="pos-name">万位</a> <a class="target-name">1码</a> <a class="num-name">1</a> <a class="period-name">100期</a>出号统计</li></ul>
                    <ul><li class="fh"><p class="fh-f5"><span v-text="data.data.times"></span><span>出现次数</span></p>
                        <p class="fh-f5"><span v-text="data.data.rate"></span><span>出现概率</span></p>
                        <p class="fh-f5"><span  v-text="data.data.max_arise"></span><span>最大连出</span></p>
                        <p class="fh-f5"><span v-text="data.data.arise"></span><span>当前连出</span></p>
                      </li>
                        <li class="fh">
                            <p class="fh-f5"><span v-text="data.data.t_arise"></span><span>理论次数</span></p>
                            <p class="fh-f5"><span v-text="data.data.miss"></span><span>当前遗漏</span></p>
                            <p class="fh-f5"><span  v-text="data.data.max_miss"></span><span>最大遗漏</span></p>
                            <p class="fh-f5"><span v-text="data.data.avg_miss"></span><span>平均遗漏</span></p>
                           </li></ul></div>
        ...
        <div class="lg-analysize-count">
            <div class="lg-analysize-count-title common-title">
                <div style="text-align: center"><?php echo $gameinfo['title']; ?><span class="pos-name">万位</span> <span class="target-name">1码</span> <span class="num-name">1</span> <span class="period-name">100期</span> 之前之后统计</div>
                <div style="display: none">
                    <form class="layui-form">
                        <div class="layui-form-item">
                            <label class="layui-form-label">显示:</label>
