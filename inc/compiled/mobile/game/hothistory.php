...
<div class="container cst-mainbody" style="padding:0;">
    ...
    <div class="lg-hot-history-tab">
        ...
        ?>
        <span data-val="<?php echo $key+1;?>" <?php if($action==$key+1){?>class="active"<?php }?>><?php echo $value;?></span>
        <?php } ?>
    </div>
    <!--选择号码-->

    <!--选择日期-->
    <div class="lg-history-title" style="display: none">
        <div class="lg-history-title-left"><span><?php echo $pos_arr[$action]; ?></span>号码历史</div>
        <div class="lg-history-title-issue">
            <form class="layui-form">
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <input type="radio" name="sort" lay-filter="issue"   value="5" title="5日" checked>
                        <input type="radio" name="sort" lay-filter="issue"   value="10" title="10日" >
...
<script>
    var param = {day:5,pos:1,target:<?php echo $nav_list[$action]['target']; ?>,period:100,sort:'num',desc:'1',type:'history'};
    var wei_sum=<?php echo $wei_sum;?>

</script>
<script type="text/javascript" src="<?php echo $HttpPath; ?>static/web/js/cqssc/hot-history.js?v=c167ceaa2357dd0f98caf9a7514f1ea5"></script>
