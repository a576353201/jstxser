<div class="common-zs-table" style="position: relative;">
    <table>
        ...
        <tr>
            ...
            <td width="50px;">33~37</td>
            <td width="50px;">38~42</td>
            <td width="50px;">43~45</td>
            <td width="30px;">大</td>
            <td width="30px;">小</td>
            <td width="30px;">单</td>
            <td width="30px;">双</td>
        ...
        <tr v-for="(l,i) in data">
            ...
            <td width="30px" class="line-10 b0" v-bind:class="hmylfcFun(i,k+1)" v-for="(item,k) in 10"  v-html="num1Html(l.sum_val,k,l.miss)"></td>
            <td class="line-2" v-bind:class="hmylfcFun(i,k+11)" v-for="(item,k) in 2" v-html="dxHtml(l.sum_dx,k,l.miss)"></td>
            <td class="line-2" v-bind:class="hmylfcFun(i,k+13)" v-for="(item,k) in 2" v-html="dsHtml(l.sum_ds,k,l.miss)"></td>
            <td class="line-3" v-bind:class="hmylfcFun(i,k+15)" v-for="(item,k) in 3" v-html="luHtml(l.sum_012,k,l.miss)"></td>
            <td class="line-3" v-bind:class="hmylfcFun(i,k+18)" v-for="(item,k) in 3" v-html="spjHtml(l.sum_spj,k,l.miss)"></td>
        </tr>
        <tr v-if="indexTime == 2">
            <td>
                {{dateTime}}<a style="color:deeppink;">{{resetIssue}}</a>
        ...
        <tr>
            <td colspan="10" width="30px;">和值</td>
            <td colspan="2">大小</td>
            <td colspan="2">单双</td>
            <td colspan="3">012</td>
            <td colspan="3">升平降</td>
...
<script>
    var fields = {
        max:[0],
        sum_range: ['0-2','3-7','8-12','13-17','18-22','23-27','28-32','33-37','38-42','43-45'],
        sum_dx:['大','小'],
        sum_ds:['单','双'],
        sum_012:[0,1,2],
        sum_spj:['升','平','降']
