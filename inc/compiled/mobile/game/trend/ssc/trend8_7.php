<div class="common-zs-table" style="position: relative;">
    <table>
        ...
        <tr v-for="(l,i) in data">
            ...
            <td class="border-td" v-html="fontColorFun(l.zh)"></td>
            <td class="line-4" v-bind:class="hmylfcFun(i,k+9)" v-for="(item,k) in 5" v-html="dxbHtml(l.zh_p,k,l.miss)"></td>
        </tr>
        <tr  v-if="indexTime == 2">
            <td>
                {{dateTime}}<a style="color:deeppink;">{{resetIssue}}</a>
...
<script type="text/javascript" src="<?php echo $HttpPath; ?>static/web/js/cqssc/cqssc-trend8_5.js?v=c167ceaa2357dd0f98caf9a7514f1ea5"></script>