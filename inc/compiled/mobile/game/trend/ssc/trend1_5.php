<div class="common-zs-table" style="position: relative;">
    <table>
        ...
        <tr>
            ...
            <td colspan="2">十位</td>
            <td colspan="2">个位</td>
            <td rowspan="2" width="70px;">单双单选</td>
            <td colspan="6">单双比</td>
        </tr>
        <tr>
            <td width="30px;">单</td>
        ...
        <tr class="tbody-yc" v-if="indexsort == 1">
            ...
            <td style="cursor: pointer;" @click="dx5Fun2(1)"><p class="big" v-show="dx5count2 == 1">单</p></td>
            <td style="cursor: pointer;" @click="dx5Fun2(2)"><p class="small" v-show="dx5count2 == 2">双</p></td>
        ...
        <tr class="tbody-yc" v-if="indexsort == 1">
            ...
            <td style="cursor: pointer;" @click="dx5Fun1(1)"><p class="big" v-show="dx5count1 == 1">单</p></td>
            <td style="cursor: pointer;" @click="dx5Fun1(2)"><p class="small" v-show="dx5count1 == 2">双</p></td>
            <td style="cursor: pointer;">-</td>
        ...
        <tr v-if="indexTime == 1">
            ...
            <td style="cursor: pointer;" @click="dx5Fun(1)"><p class="big" v-show="dx5count == 1">单</p></td>
            <td style="cursor: pointer;" @click="dx5Fun(2)"><p class="small" v-show="dx5count == 2">双</p></td>
            <td style="cursor: pointer;">-</td>
        ...
        <tr v-for="(l,i) in data">
            ...
            <td style="width: 50px;" class="border-td"  v-html="fontColorFun(l.ds)"></td>
            <td class="line-6" v-bind:class="hmylfcFun(i,k+11)" v-for="(item,k) in 6" v-html="dxbHtml(l.ds_p,k,l.miss)"></td>
        </tr>
        <tr v-if="indexTime == 2">
            <td>
                {{dateTime}}<a style="color:deeppink;">{{resetIssue}}</a>
