<div class="common-zs-table" style="position: relative;">
    <table>
        ...
        <tr v-for="(l,i) in data">
            <td class="border-td border-R" v-html="expectFun(l.expect)"></td>
...
<script type="text/javascript" src="<?php echo $HttpPath; ?>static/web/js/pk10/pk10-trend1_1.js?v=c167ceaa2357dd0f98caf9a7514f1ea5"></script>
