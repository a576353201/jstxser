...
<span class='title'  style='float:left;line-height:40px;'>选择参赛队伍: </span>
<span  style='float:left;line-height:40px;padding-left:10px;'>
<?php if(is_array($team)){foreach($team AS $index=>$value) { ?>
<input type='checkbox' name='team_id[]' value='<?php echo $value['id']; ?>'>
<a href='../team/index.php?id=<?php echo $value['id']; ?>' ><?php echo $value['name']; ?></a>
<br>
<?php }}?>
</span>
