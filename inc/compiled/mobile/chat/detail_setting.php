...
<ul class="profile" >
    ...
    <li>
        ...
        <img src="<?php echo $group['avatar']; ?>" id="group_avatar" style="height: 45px;width: 45px;border-radius: 5px;vertical-align: middle" onclick="document.querySelector('#cameraInput').click();"/>
        <img src="/static/images/icon-plus.png"  onclick="document.querySelector('#cameraInput').click();"  style="height: 45px;width: 45px;margin-left: 15px;vertical-align: middle"/>
    </li>
...
//        parent.layer.iframeAuto(index);
    ...
    function save_info() {
        ...
        $.post("../api/group.php?act=updateinfo",{id:<?php echo $group['id']; ?>,name:$('#name').val(),content:$('#content').val(),tags:tags,no_invite:no_invite,no_speaking:no_speaking,is_mark:is_mark}, function(result){
            ...
            if(res.code=='200'){
              ...
              //  $('#group_title').html($('#name').val());
                setTimeout(function () {
                    location.href="detail.php?step=3&id=<?php echo $group['id']; ?>";
                },500)
            }else{
