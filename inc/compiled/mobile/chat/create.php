...
<div class="header" style="padding: 5px 0px">
    <span class="back" onclick="close_layer();" style="top:5px;"><i class="icon-left-open-3"></i></span>
    <span class="title">创建群聊</span>

</div>
<ul class="profile" style="margin-top: 50px" >
    <li>名称：</li>
    <li><input type="text" class="input1" id="name" value="" placeholder="请输入聊天室名称">
...
<ul class="profile" >
    <li>介绍：</li>
    <li>
        <textarea id="content" placeholder="请输入聊天室介绍"></textarea>
...
<ul class="profile" >
    ...
    <li style="vertical-align: middle;line-height: 30px;">
        <div class="tags_show" style="vertical-align: middle">

        </div>

        <div  style="vertical-align: middle" class="add_btn" onclick="add_tags();"><i class="icon-plus-circle" ></i>选择标签</div>
    </li>

</ul>

<div style="width: 80%;margin: 15px auto;display: block">
...
//        if($('#content').val()==''){
//            layer.msg("请输入聊天室介绍",{ type: 1, anim: 2 ,time:2000});
//            return false;
//        }
//        if($('#content').val().length<5){
//            layer.msg("聊天室介绍不能少于5个字",{ type: 1, anim: 2 ,time:1000});
//            return false;
//        }
        if(is_loading==1){
            sub=1;
