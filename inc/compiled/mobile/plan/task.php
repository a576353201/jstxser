...
<style>
    ...
    .box{
        ...
        box-shadow: 2px 2px 4px 2px #3388ff, -2px 2px 2px 2px #3388ff;
    ...
    <div class="header" style="padding: 5px 0px;">
        <span class="back" onclick="close_this();" style="top:5px;"><i class="icon-left-open-3"></i></span>

        <ul class="nav" style="width: 60%;left: 20%;top:5px;">
            <?php if(is_array($plan_grade_arr)){foreach($plan_grade_arr AS $index=>$value) { ?>
            <?php if($index>0){?>
            <li class="item" onclick="change_tab(<?php echo $index; ?>);" style="border-right: 1px solid #2319dc">
