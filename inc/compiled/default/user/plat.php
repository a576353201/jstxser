...
<ul class="profile" style="margin-top: 8px;">
    <input type="button" value="确认提现" class="button1" onclick="return click_bind();">
         ...
         <script>
             var plat_min=parseInt(<?php echo $system['plat_min']; ?>);
             var plat_max=parseInt(<?php echo $system['plat_max']; ?>);
             ...
             function click_bind() {
                 ...
                 if (parseFloat(money) - parseFloat(plat_min) < 0) {
                     parent.layer.msg('每次最少提现'+ plat_min + '元！',{ type: 1, anim: 2 ,time:1000});
                     document.getElementById('money').focus();
                     return false;
                 }
