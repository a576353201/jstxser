...
var user_agree='<?php echo $user['agree']; ?>';
...
<iframe src='../upload_pc.php?fileid=file_add1&img=<?php echo $file['file1']; ?>&iframeid=upload_src1&num=2&dir=icp'  id='upload_src1'  style='width:100%;height:100px;'marginwidth="0px" frameborder="0" scrolling="no" ></iframe>
</div>
...
<iframe src='../upload_pc1.php?fileid=file_add2&img=<?php echo $file['file2']; ?>&info=<?php echo $file['info']; ?>&iframeid=upload_src2'  id='upload_src2'  style='width:100%;height:100px;'marginwidth="0px" frameborder="0" scrolling="no" ></iframe>
</div>
