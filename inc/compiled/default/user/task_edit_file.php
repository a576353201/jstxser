...
<?php include_once template("user/left");?>
 ...
 <div class='user_nav'>
当前位置：<a href='index.php'>个人中心</a> &gt;<a href='task_me.php'>我管理的比赛</a>&gt;<a href='task_edit.php?type=<?php echo $type; ?>&id=<?php echo $_GET['id']; ?>'><?php echo $task['title']; ?></a> &gt;上传附件
...
?>
    ...
    <div style='font-size:20px;'>上传附件<span class="icon_add1" onclick="file_add();"></span>
    </div>
