...
<a href='<?php echo $HttpPath; ?>player.php?group=<?php echo $user['group']; ?>'><?php echo $user_group[$user['group']]; ?></a>&gt;&gt;
...
<input type='hidden' name='group'  value='<?php echo $user['group']; ?>'>

<input type="text" name="realname" value="" style="width: 150px;border: 1px solid #dbdbdb;height: 30px;line-height: 30px;padding: 0 10px;">
...
<img src="<?php echo avatar($user['id']); ?>" style='width:200px;height:200px;border:1px solid #ddd;border-radius:5px;padding:3px;'>
...
<span class='title'>主页地址:</span> <a href='<?php echo $HttpPath; ?>user/space.php?uid=<?php echo $_GET['uid']; ?>'><?php echo $HttpPath; ?>user/space.php?uid=<?php echo $_GET['uid']; ?></a><br>
<span class='title'>上次登录时间:</span> <?php echo date('Y-m-d H:i:s',$user['logintime']); ?><br>
<span class='title'>注册时间:</span> <?php echo date('Y-m-d H:i:s',$user['regtime']); ?>
...
<img src='<?php echo $HttpPath; ?><?php echo $value; ?>' onclick="show_img11(<?php echo $index; ?>,0);"  style='curosr: pointer;'  name='img_show'>
...
var img_sum=<?php echo count($file2)+1;?>;
var img_num=0;
var xx=0;
...
var x=-parseInt(document.body.offsetWidth)*(num+1);
...
xx=xx+temp;
document.getElementById("sw").style.transform='translate3d('+xx+'px, 0px, 0px)';
var elStyle=document.getElementById("sw").style;
elStyle.webkitTransform = elStyle.MsTransform  = elStyle.MozTransform = elStyle.OTransform = elStyle.transform;
    ...
    .swiper-pagination{display:none;}
     ...
     <div class="swiper-container">
        ...
        <?php if(is_array($file2)){foreach($file2 AS $index=>$value) { ?>
         ...
         <img src="<?php echo $HttpPath; ?><?php echo $value; ?>"     onclick="set_info11('myinfo_<?php echo $index; ?>');">


         <div class='show_info' id='myinfo_<?php echo $index; ?>'   >
         <span style='color:#bbb'>(<span style='color:#ff0000;font-weight:600;'><?php echo $index+1;?></span>/<?php echo count($file2); ?>)</span><?php echo $info[$index]; ?>
         </div>
        ...
        <div style='display:block;font-size:32px;color:#fff;font-weight:600;line-height:50px;'  onclick="show_img11(0,0)">
        <img src="<?php echo $HttpPath; ?>static/images/fresh.png"  style='height:100px;'><br>
        重看
             <br>
        <div style='display:block;font-size:14px;color:#ccc;'>已到达最后一页</div>
        ...
        <!-- Add Arrows -->
        <div class="swiper-button-next" id='banner_next' onclick="show_next(1);" ></div>
        <div class="swiper-button-prev" onclick="show_next(-1);"  ></div>
    </div>
