...
<ul class="nav1" >
    <li class="active" onclick="change_tab(0);">修改<?php echo $pwdname; ?>密码</li>
    <li class="" onclick="change_tab(1);">忘记<?php echo $pwdname; ?>密码</li>
</ul>
...
<div class="step" style="padding:10px;">
    ...
    <div class="login-lines1">
        <div class="line">
            ...
            <input type="password" id="oldpwd" value="" class="input1" maxlength="6" placeholder="原始<?php echo $pwdname; ?>密码,6位数字" onblur="check_other(this.value,'oldpwd');">
        </div>
    ...
    <div class="login-lines1">
        <div class="line">
            <i class="icon icon-lock"></i>
            <input type="password" id="password" value="" class="input1" maxlength="6" placeholder="新<?php echo $pwdname; ?>密码,6位数字" oninput="checkpwd(this.value);" onblur="check_other(this.value,'password');check_other($('#password2').val(),'password1');">
        </div>
    ...
    <div class="login-lines1">
        <div class="line">
            <i class="icon icon-lock"></i>
            <input type="password" id="password2" value="" class="input1" maxlength="6" placeholder="再次输入新<?php echo $pwdname; ?>密码" onblur="check_other(this.value,'password1');">
        </div>
...
<div class="step" style="padding:10px;">
    ...
    <ul class="profile" >
        ...
        <li><input type="password" class="input1" id="pwd" value="" maxlength="6" placeholder="新的<?php echo $pwdname; ?>密码,,6位数字"  onblur="check_other(this.value,'pwd');">
...
<script>
    ...
    function reset_pwd() {
        ...
        if(parseInt($('#pwd').val())>0 && parseInt($('#pwd').val())<1000000 && $('#pwd').val().length==6){
            ...
            layer.msg("<?php echo $pwdname; ?>密码必须为6位数字",{ type: 1, anim: 2 ,time:1000});
            return false;
        }
    ...
    function change_pwd() {
        ...
        if(parseInt($('#password').val())>0 && parseInt($('#password').val())<1000000 && $('#password').val().length==6){
    ...
    function check_other(value,name) {
        ...
        if(value.length>0){
            if(name=='password' || name=='oldpwd' || name=='password1'){
                if(parseInt(value)>0 && parseInt(value)<1000000 && value.length==6){
