...
单位名称：<input type="text" name="dw_name" value="<?php echo $_GET['dw_name']; ?>" >&nbsp;&nbsp;
...
运动员</span></div></td>
 	...
 	<?php if(is_array($list)){foreach($list AS $index=>$value) { ?>
          ...
          <tr>
                    <td><div align="center"><a href='index.php?id=<?php echo $value['id']; ?>' target='_blank'><?php echo $value['name']; ?></a></div></td>
            <td><div align="center"><span class="STYLE1"><?php echo $value['user']['realname']; ?></span></div></td>


    <td><div align="center"><span class="STYLE1"> <?php echo count($value['arrive']); ?> </span></div></td>

                      <td><div align="center"><span class="STYLE1"><?php echo count($value['level']); ?></span></div></td>
...
<a href='index.php?id=<?php echo $value['id']; ?>' target='_blank'>预览</a>
            </td>
