    ...
    <div class="content" style="height:460px;">
        ...
        <div class="left" style="height:460px;border: 0px;">
            ...
            <div class="sender" style="height:130px;">
                ...
                <div class="btns">
                    <div class="btn" onclick="parent.close_chatone(<?php echo $group['id']; ?>)"><i class="icon-cancel"></i>关闭</div>
                    <div class="btn active" onclick="submitMsg();"><i class="icon-ok"></i>发送</div>
                </div>
            </div>
        </div>
    ...
    function  addone(data) {
        ...
        if(data.message.type=='apply'){
           var content=data.message.content;
              ...
              var content1="<span class=\"groupname\" onclick=\"parent.user_detail("+uid+");\">"+nickname+"</span> 申请加入群：<span class=\"groupname\" onclick=\"parent.group_detail("+content.other.groupid+");\">"+content.other.groupname+"</span>";
