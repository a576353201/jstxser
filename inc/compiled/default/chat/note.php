...
<div class="group_note">
    <div class="menu">
       名称：<?php echo $group['name']; ?>
        ...
        <div class="btn" onclick="location.href='noteadd.php?group_id=<?php echo $group['id']; ?>';"><i class="icon-edit"></i>发布公告</div>
<?php }?>
    </div>
<div class="content">
...
?>
    ...
    <div class="timer">
       ...
       <?php if($is_owner==1 || $is_manager==1){ ?>
        <span style="float: left">
           <a style="color: #3388ff;margin-right: 3px;" href="noteadd.php?id=<?php echo $value['id']; ?>&group_id=<?php echo $group['id']; ?>">
                <i class="icon-edit"></i>编辑
           </a>

                <a style="color: #3388ff;margin-right: 3px;" onclick="delete_note(<?php echo $value['id']; ?>);">
   ...
   <?php echo $value['nickname']; ?>发布于<?php echo date('Y-m-d H:i',$value['addtime']); ?> <span style="color: #3388ff;margin-right: 3px;"><?php echo $value['view']; ?>人已阅读</span>
