...
<table class="history_11x5">
    ...
    <tr>
        ...
        <td data-val="1" style="width:50px">和</td>
        <td data-val="2" style="width:50px">大小</td>
        <td data-val="3" style="width:50px">单双</td>
    ...
    <tr>
        ...
        <td data-val="6" style="color:#fd0000;">龙</td>
        <?php }elseif($value['number_arr'][0]<$value['number_arr'][4]){ ?>
        <td data-val="6" style="color:#0867d1;">虎</td>
        <?php }else{ ?>
        <td data-val="6" style="color:green;">和</td>

        <?php } ?>

        <td data-val="7"><?php echo $value['number_xt'][0]; ?></td>
        <td data-val="8"><?php echo $value['number_xt'][1]; ?></td>
        <td data-val="9"><?php echo $value['number_xt'][2]; ?></td>
    </tr>
    <?php }}?>
