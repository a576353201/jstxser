<div class="common-zs-table" style="position: relative;">
    <table>
        ...
        <tr>
            <td width="30px;" v-for="k in 6" v-text="k-1" v-bind:id="k == 1 ?'num':''"></td>
            <td width="40px;">大</td>
            <td width="40px;">小</td>
            <td width="40px;">单</td>
            <td width="40px;">双</td>
        ...
        <tr class="tbody-yc" v-if="indexsort == 1">
            ...
            <td colspan="3">-</td>
            <td style="cursor: pointer;" v-for="num in 6" v-on:click="tdTabNum1($event.target,num)"><p class="b0" style="position: relative;z-index: 999;width: 25px;height: 25px;display: block;margin: 0 auto;border-radius:50%;"></p></td>
        ...
        <tr v-for="(l,k) in data">
            ...
            <td v-bind:class="hmylfcFun(k,i)" class="line-6 b0" v-for="(item,i) in 6"  v-html="numHtml(item,l.span,k,i,l.miss)"></td>
            <td class="line-2" v-bind:class="hmylfcFun(k,i+6)" v-for="(item,i) in 2" v-html="dxHtml(l.span_dx,k,i,l.miss)"></td>
            <td class="line-2" v-bind:class="hmylfcFun(k,i+8)" v-for="(item,i) in 2" v-html="dsHtml(l.span_ds,k,i,l.miss)"></td>
            <td class="line-3" v-bind:class="hmylfcFun(k,i+10)" v-for="(item,i) in 3" v-html="luHtml(l.span_012,k,i,l.miss)"></td>
            <td class="line-3"v-bind:class="hmylfcFun(k,i+13)" v-for="(item,i) in 3" v-html="spHtml(l.span_spj,k,i,l.miss)"></td>
        </tr>
        ...
        <tr>
            ...
            <td rowspan="2" colspan="3" width="90px;">开奖号</td>
            <td width="30px;" v-for="k in 6" v-text="k"></td>
            <td width="40px;">大</td>
            <td width="40px;">小</td>
            <td width="40px;">单</td>
            <td width="40px;">双</td>
