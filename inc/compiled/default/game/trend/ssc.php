...
<div style="background-color: #ffffff;">
    ...
    <div class="common-zs-tab common-zs-tab-div">
        ...
        <div>
            <span><?php echo $value1; ?>走势:</span>

            <?php if(is_array($pos_arr[$key1])){foreach($pos_arr[$key1] AS $key2=>$value2) { ?>
            <a href="?pos_type=<?php echo $key1; ?>&pos_num=<?php echo $key2; ?>" <?php if($pos_type==$key1 && $pos_num==$key2){?>class="active" <?php }?>><?php echo $value2; ?></a>
            <?php if(($key1==1 and $key2!=count($pos_arr[$key1])-1) or ($key1!=1 and $key2<count($pos_arr[$key1]))) echo '<b>|</b>';?>
    ...
    <div class="common-zs-tab-title"><?php echo $gameinfo['title']; ?><?php echo $pos_wei[$pos_type]; ?><?php echo $pos_arr[$pos_type][$pos_num]; ?>走势图
