<div class="common-zs-table" style="position: relative;">
    <table>
        ...
        <tr>
            ...
            <td colspan="10" width="30px;">百位</td>
            <td colspan="10" width="30px;">十位</td>
        ...
        <tr v-for="(l,i) in data">
            ...
            <td width="30px" class="line-10 b0" v-bind:class="hmylfcFun(i,k)" v-for="(item,k) in 10" v-html="num1Html(l.num2,k,l.miss)"></td>
            <td width="30px" class="line-10 b1" v-bind:class="hmylfcFun(i,k+10)" v-for="(item,k) in 10" v-html="num2Html(l.num3,k,l.miss)"></td>
            <td width="30px" class="line-10 b2" v-bind:class="hmylfcFun(i,k+20)" v-for="(item,k) in 10" v-html="num3Html(l.num4,k,l.miss)"></td>
            <?php } else { ?>
            <td width="30px" class="line-10 b0" v-bind:class="hmylfcFun(i,k)" v-for="(item,k) in 10" v-html="num1Html(l.num3,k,l.miss)"></td>
            <td width="30px" class="line-10 b1" v-bind:class="hmylfcFun(i,k+10)" v-for="(item,k) in 10" v-html="num2Html(l.num4,k,l.miss)"></td>
            <td width="30px" class="line-10 b2" v-bind:class="hmylfcFun(i,k+20)" v-for="(item,k) in 10" v-html="num3Html(l.num5,k,l.miss)"></td>
            <?php }?>

            <td style="width:40px;" class="border-td" v-text="l.status2"></td>
            <td style="width:40px;" class="border-td" v-text="l.sum_val"></td>
            <td style="width:40px;" class="border-td" v-text="l.span"></td>
            <td style="width:40px;" class="border-td" v-text="l.area"></td>
        </tr>
        <tr v-if="indexTime == 2">
            <td>
                {{dateTime}}<a style="color:deeppink;">{{resetIssue}}</a>
        ...
        <tr>
            ...
            <td width="30px;" v-for="(l,n) in sta.times" v-text="lH3xtml(l,n)"></td>
        </tr>
        <tr>
            <td colspan="6">最大连出</td>
            <td width="30px;" v-for="(l,n) in sta.max_out" v-text="lH3xtml(l,n)"></td>
        </tr>
        <tr>
            <td colspan="6">最大遗漏</td>
            <td width="30px;" v-for="(l,n) in sta.max_miss" v-text="lH3xtml(l,n)"></td>
        </tr>
        <tr>
            <td colspan="6">平均遗漏</td>
            <td width="30px;" v-for="(l,n) in sta.avg_miss" v-text="lH3xtml(l,n)"></td>
        </tr>
        </tbody>
    </table>
...
<script type="text/javascript" src="<?php echo $HttpTemplatePath; ?>51cp/static/web/js/cqssc/cqssc-trend1_<?php echo $pos_num; ?>.js?v=c167ceaa2357dd0f98caf9a7514f1ea5"></script>
