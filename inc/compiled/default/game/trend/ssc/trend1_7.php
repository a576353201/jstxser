<div class="common-zs-table" style="position: relative;">
    <table>
        ...
        <tr>
            ...
            <td colspan="6">0路个数</td>
            <td colspan="6">1路个数</td>
            <td colspan="6">2路个数</td>
        </tr>
        <tr>
        ...
        <tr class="tbody-yc" v-if="indexsort == 1">
            ...
            <td style="cursor: pointer;" @click="dx5Fun2(1)"><p class="big" v-show="dx5count2 == 1">0</p></td>
            <td style="cursor: pointer;" @click="dx5Fun2(2)"><p class="shuang" v-show="dx5count2 == 2">1</p></td>
            <td style="cursor: pointer;" @click="dx5Fun2(3)"><p class="dan" v-show="dx5count2 == 3">2</p></td>
        ...
        <tr class="tbody-yc" v-if="indexsort == 1">
            ...
            <td style="cursor: pointer;" @click="dx5Fun1(1)"><p class="big" v-show="dx5count1 == 1">0</p></td>
            <td style="cursor: pointer;" @click="dx5Fun1(2)"><p class="shuang" v-show="dx5count1 == 2">1</p></td>
            <td style="cursor: pointer;" @click="dx5Fun1(3)"><p class="dan" v-show="dx5count1 == 3">2</p></td>
            <td style="cursor: pointer;">-</td>
        ...
        <tr v-if="indexTime == 1">
            ...
            <td style="cursor: pointer;" @click="dx5Fun(1)"><p class="big" v-show="dx5count == 1">0</p></td>
            <td style="cursor: pointer;" @click="dx5Fun(2)"><p class="shuang" v-show="dx5count == 2">1</p></td>
            <td style="cursor: pointer;" @click="dx5Fun(3)"><p class="dan" v-show="dx5count == 3">2</p></td>
            <td style="cursor: pointer;">-</td>
        ...
        <tr v-for="(l,i) in data">
            ...
            <td class="line-3" v-bind:class="hmylfcFun(i,k+12)" v-for="(item,k) in 3" v-html="road5Html(l.road5,k,l.miss)"></td>
            <td style="width: 50px;" class="border-td"  v-html="fontColorFun(l['012'])" ></td>
            <td class="line-6" v-bind:class="hmylfcFun(i,k+16)" v-for="(item,k) in 6" v-html="road0CountHtml(l.road0count,k,l.miss)"></td>
            <td class="line-6" v-bind:class="hmylfcFun(i,k+22)" v-for="(item,k) in 6" v-html="road1CountHtml(l.road1count,k,l.miss)"></td>
            <td class="line-6" v-bind:class="hmylfcFun(i,k+28)" v-for="(item,k) in 6" v-html="road2CountHtml(l.road2count,k,l.miss)"></td>
        </tr>
        <tr  v-if="indexTime == 2">
            <td>
                {{dateTime}}<a style="color:deeppink;">{{resetIssue}}</a>
...
<script>
    ...
    var fields = {
        ...
        road5:[0,1,2],
        '012':[0],
        road0count:[0,1,2,3,4,5],
        road1count:[0,1,2,3,4,5],
        road2count:[0,1,2,3,4,5]
