<div class="common-zs-table" style="position: relative;">
    <table>
        ...
        <tr>
            <td width="50px;" id="num">0~2</td>
            <td width="50px;">3~7</td>
            <td width="50px;">8~12</td>
            <td width="50px;">13~17</td>
            <td width="50px;">18~22</td>
            <td width="50px;">23~27</td>
            <td width="50px;">28~32</td>
            <td width="50px;">33~36</td>
            <td width="30px;">大</td>
            <td width="30px;">小</td>
            <td width="30px;">单</td>
            <td width="30px;">双</td>
        ...
        <tr class="tbody-yc" v-if="indexsort == 1">
            ...
            <td colspan="5">-</td>
            <td>-</td>
            <td style="cursor: pointer;" v-for="num in 8" v-on:click="tdTabNum1($event.target,num-1)"><p class="b0" style="position: relative;z-index: 999;width: 25px;height: 25px;display: block;margin: 0 auto;border-radius:50%;"></p></td>
        ...
        <tr v-for="(l,i) in data">
            ...
            <td width="30px" class="line-10 b0" v-bind:class="hmylfcFun(i,k+1)" v-for="(item,k) in 8"  v-html="num1Html(l.sum_val,k,l.miss)"></td>
            <td class="line-2" v-bind:class="hmylfcFun(i,k+9)" v-for="(item,k) in 2" v-html="dxHtml(l.sum_dx,k,l.miss)"></td>
            <td class="line-2" v-bind:class="hmylfcFun(i,k+11)" v-for="(item,k) in 2" v-html="dsHtml(l.sum_ds,k,l.miss)"></td>
            <td class="line-3" v-bind:class="hmylfcFun(i,k+13)" v-for="(item,k) in 3" v-html="luHtml(l.sum_012,k,l.miss)"></td>
            <td class="line-3" v-bind:class="hmylfcFun(i,k+16)" v-for="(item,k) in 3" v-html="spjHtml(l.sum_spj,k,l.miss)"></td>
        </tr>
        <tr  v-if="indexTime == 2">
            <td>
                {{dateTime}}<a style="color:deeppink;">{{resetIssue}}</a>
...
<script>
    ...
    var fields = {
        max:[0],
        sum_range: ['0-2','3-7','8-12','13-17','18-22','23-27','28-32','33-36'],
        sum_dx:['大','小'],
        sum_ds:['单','双'],
        sum_012:[0,1,2],
        sum_spj:['升','平','降']
