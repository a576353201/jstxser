<div class="common-zs-table" style="position: relative;">
    <table>
        ...
        <tr v-for="(l,i) in data">
            ...
            <td style="width: 65px;" class="border-td"  v-html="fontColorFun(l['spj'])"></td>
            <td class="line-5" v-bind:class="hmylfcFun(i,k+13)" v-for="(item,k) in 5" v-html="road0CountHtml(l.spj0count,k,l.miss)"></td>
            <td class="line-5" v-bind:class="hmylfcFun(i,k+18)" v-for="(item,k) in 5" v-html="road1CountHtml(l.spj1count,k,l.miss)"></td>
            <td class="line-5" v-bind:class="hmylfcFun(i,k+23)" v-for="(item,k) in 5" v-html="road2CountHtml(l.spj2count,k,l.miss)"></td>
        </tr>
        <tr  v-if="indexTime == 2">
            <td>
                {{dateTime}}<a style="color:deeppink;">{{resetIssue}}</a>
...
<script type="text/javascript" src="<?php echo $HttpTemplatePath; ?>51cp/static/web/js/cqssc/cqssc-trend8_8.js?v=c167ceaa2357dd0f98caf9a7514f1ea5"></script>