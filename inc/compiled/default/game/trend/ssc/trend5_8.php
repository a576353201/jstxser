<div class="common-zs-table" style="position: relative;">
    <table>
        ...
        <tr v-for="(l,i) in data">
            ...
            <td class="border-td" v-text="l['012']" style="width: 60px;"></td>
            <td class="line-10" v-bind:class="hmylfcFun(i,k+10)" v-for="(item,k) in 10" v-html="dxbHtml(l['012_p'],k,l.miss)"></td>
        </tr>
        <tr  v-if="indexTime == 2">
            <td>
                {{dateTime}}<a style="color:deeppink;">{{resetIssue}}</a>
...
<script>
    var fields = {
        ...
        road3:[0,1,2],
        '012':[0],
        '012_p':['3:0:0','2:1:0','2:0:1','1:1:1','1:2:0','1:0:2','0:3:0','0:2:1','0:1:2','0:0:3']
    };
