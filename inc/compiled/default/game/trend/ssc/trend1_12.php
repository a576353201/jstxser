<div class="common-zs-table" style="position: relative;">
    <table>
        ...
        <tr class="tbody-yc" v-if="indexsort == 1">
            ...
            <td colspan="5">-</td>
            <td>-</td>
            <td style="cursor: pointer;" class="b0" v-for="num in 10" v-on:click="tdTabNum1($event.target,num-1)"><span></span></td>
        ...
        <tr v-for="(l,i) in data">
            ...
            <td class="border-td" v-text="l.min" style="width: 40px;"></td>
            <td width="30px" class="line-10 b0" v-bind:class="hmylfcFun(i,k+1)" v-for="(item,k) in 10" v-bind:id="k == 0 && i == 0?'num':''" v-html="num1Html(l.min,k,l.miss)"></td>
            <td class="line-2" v-bind:class="hmylfcFun(i,k+11)" v-for="(item,k) in 2" v-html="dxHtml(l.min_dx,k,l.miss)"></td>
            <td class="line-2" v-bind:class="hmylfcFun(i,k+13)" v-for="(item,k) in 2" v-html="dsHtml(l.min_ds,k,l.miss)"></td>
            <td class="line-2" v-bind:class="hmylfcFun(i,k+15)" v-for="(item,k) in 2" v-html="zhHtml(l.min_zh,k,l.miss)"></td>
            <td class="line-3" v-bind:class="hmylfcFun(i,k+17)" v-for="(item,k) in 3" v-html="luHtml(l.min_012,k,l.miss)"></td>
            <td class="line-3" v-bind:class="hmylfcFun(i,k+20)" v-for="(item,k) in 3" v-html="spjHtml(l.min_spj,k,l.miss)"></td>
        </tr>
        <tr  v-if="indexTime == 2">
            <td>
                {{dateTime}}<a style="color:deeppink;">{{resetIssue}}</a>
        ...
        <tr>
            <td colspan="10" width="30px;">最小号</td>
            <td colspan="2">大小</td>
            <td colspan="2">单双</td>
            <td colspan="2">质合</td>
            <td colspan="3">012</td>
...
<script type="text/javascript" src="<?php echo $HttpTemplatePath; ?>51cp/static/web/js/cqssc/cqssc-trend1_11.js?v=c167ceaa2357dd0f98caf9a7514f1ea5"></script>