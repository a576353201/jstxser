<div class="common-zs-table" style="position: relative;">
    <table>
        ...
        <tr class="tbody-yc" v-if="indexsort == 1">
            ...
            <td style="cursor: pointer;" @click="dx3Fun2(1)"><p class="dan" v-show="dx3count2 == 1">单单</p></td>
            <td style="cursor: pointer;" @click="dx3Fun2(2)"><p class="dan" v-show="dx3count2 == 2">单双</p></td>
            <td style="cursor: pointer;" @click="dx3Fun2(3)"><p class="dan" v-show="dx3count2 == 3">双单</p></td>
            <td style="cursor: pointer;" @click="dx3Fun2(4)"><p class="dan" v-show="dx3count2 == 4">双双</p></td>
        ...
        <tr class="tbody-yc" v-if="indexsort == 1">
            ...
            <td style="cursor: pointer;" @click="dx3Fun1(1)"><p class="dan" v-show="dx3count1 == 1">单单</p></td>
            <td style="cursor: pointer;" @click="dx3Fun1(2)"><p class="dan" v-show="dx3count1 == 2">单双</p></td>
            <td style="cursor: pointer;" @click="dx3Fun1(3)"><p class="dan" v-show="dx3count1 == 3">双单</p></td>
            <td style="cursor: pointer;" @click="dx3Fun1(4)"><p class="dan" v-show="dx3count1 == 4">双双</p></td>
        ...
        <tr v-if="indexTime == 1">
            ...
            <td style="cursor: pointer;" @click="dx3Fun(1)"><p class="dan" v-show="dx3count == 1">单单</p></td>
            <td style="cursor: pointer;" @click="dx3Fun(2)"><p class="dan" v-show="dx3count == 2">单双</p></td>
            <td style="cursor: pointer;" @click="dx3Fun(3)"><p class="dan" v-show="dx3count == 3">双单</p></td>
            <td style="cursor: pointer;" @click="dx3Fun(4)"><p class="dan" v-show="dx3count == 4">双双</p></td>
        ...
        <tr v-for="(l,i) in data">
            ...
            <td class="line-4" v-bind:class="hmylfcFun(i,k+4)" v-for="(item,k) in 4" v-html="dxdxHtml(l.ds,k,l.miss)"></td>
            <td class="line-3" v-bind:class="hmylfcFun(i,k+8)" v-for="(item,k) in 3" v-html="dxbHtml(l.ds_p,k,l.miss)"></td>
        </tr>
        <tr v-if="indexTime == 2">
            <td>
                {{dateTime}}<a style="color:deeppink;">{{resetIssue}}</a>
