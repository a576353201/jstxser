<div class="common-zs-table" style="position: relative;">
    <table>
        ...
        <tr>
            ...
            <td width="30px;">单</td>
            <td width="30px;">双</td>
            <td width="30px;">单单单</td>
            <td width="30px;">单单双</td>
            <td width="30px;">单双单</td>
            <td width="30px;">单双双</td>
            <td width="30px;">双单单</td>
            <td width="30px;">双单双</td>
            <td width="30px;">双双胆</td>
            <td width="30px;">双双双</td>
        ...
        <tr v-for="(l,i) in data">
            ...
            <td width="25px;" v-text="l.num1" style="color: red;"></td>
            <td width="25px;" v-text="l.num2" style="color: red;"></td>
            <td width="25px;" v-text="l.num3" style="color: red;"></td>
            ...
            <td class="line-8" v-bind:class="hmylfcFun(i,k+6)" v-for="(item,k) in 8" v-html="dxdxHtml(l.ds,k,l.miss)"></td>
            <td class="line-4" v-bind:class="hmylfcFun(i,k+14)" v-for="(item,k) in 4" v-html="dxbHtml(l.ds_p,k,l.miss)"></td>
        </tr>
        <tr  v-if="indexTime == 2">
            <td>
                {{dateTime}}<a style="color:deeppink;">{{resetIssue}}</a>
...
<script>
    ...
    var fields = {
        ...
        num2ds:['单','双'],
        num3ds:['单','双'],
        ds:['单单单','单单双','单双单','单双双','双单单','双单双','双双单','双双双'],
