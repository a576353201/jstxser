<div class="common-zs-table" style="position: relative;">
    <table>
        ...
        <tr>
            ...
            <td width="30px;">大</td>
            <td width="30px;">小</td>
            <td width="30px;">大大大</td>
            <td width="30px;">大大小</td>
            <td width="30px;">大小大</td>
            <td width="30px;">大小小</td>
            <td width="30px;">小大大</td>
            <td width="30px;">小大小</td>
            <td width="30px;">小小大</td>
            <td width="30px;">小小小</td>
        ...
        <tr v-for="(l,i) in data">
            ...
            <td class="line-8" v-bind:class="hmylfcFun(i,k+6)" v-for="(item,k) in 8" v-html="dxdxHtml(l.dx,k,l.miss)"></td>
            <td class="line-4" v-bind:class="hmylfcFun(i,k+14)" v-for="(item,k) in 4" v-html="dxbHtml(l.dx_p,k,l.miss)"></td>
        </tr>
        <tr  v-if="indexTime == 2">
            <td>
                {{dateTime}}<a style="color:deeppink;">{{resetIssue}}</a>
...
<script>
    var fields = {
        ...
        num2dx:['大','小'],
        num3dx:['大','小'],
        dx:['大大大','大大小','大小大','大小小','小大大','小大小','小小大','小小小'],
