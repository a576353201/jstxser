<div class="common-zs-table" style="position: relative;">
    <table>
        ...
        <tr>
            ...
            <td colspan="2">十位</td>
            <td colspan="2">个位</td>
            <td rowspan="2" width="70px;">质合单选</td>
            <td colspan="6">质合比</td>
        </tr>
        <tr>
            <td width="30px;">质</td>
        ...
        <tr class="tbody-yc" v-if="indexsort == 1">
            ...
            <td style="cursor: pointer;" @click="dx4Fun2(1)"><p class="big" v-show="dx4count2 == 1">质</p></td>
            <td style="cursor: pointer;" @click="dx4Fun2(2)"><p class="small" v-show="dx4count2 == 2">合</p></td>
            <td style="cursor: pointer;" @click="dx5Fun2(1)"><p class="big" v-show="dx5count2 == 1">质</p></td>
            <td style="cursor: pointer;" @click="dx5Fun2(2)"><p class="small" v-show="dx5count2 == 2">合</p></td>
        ...
        <tr class="tbody-yc" v-if="indexsort == 1">
            ...
            <td style="cursor: pointer;" @click="dx4Fun1(1)"><p class="big" v-show="dx4count1 == 1">质</p></td>
            <td style="cursor: pointer;" @click="dx4Fun1(2)"><p class="small" v-show="dx4count1 == 2">合</p></td>
            <td style="cursor: pointer;" @click="dx5Fun1(1)"><p class="big" v-show="dx5count1 == 1">质</p></td>
            <td style="cursor: pointer;" @click="dx5Fun1(2)"><p class="small" v-show="dx5count1 == 2">合</p></td>
            <td style="cursor: pointer;">-</td>
        ...
        <tr  v-if="indexTime == 1">
            ...
            <td style="cursor: pointer;" @click="dx4Fun(1)"><p class="big" v-show="dx4count == 1">质</p></td>
            <td style="cursor: pointer;" @click="dx4Fun(2)"><p class="small" v-show="dx4count == 2">合</p></td>
            <td style="cursor: pointer;" @click="dx5Fun(1)"><p class="big" v-show="dx5count == 1">质</p></td>
            <td style="cursor: pointer;" @click="dx5Fun(2)"><p class="small" v-show="dx5count == 2">合</p></td>
            <td style="cursor: pointer;">-</td>
        ...
        <tr v-for="(l,i) in data">
            ...
            <td class="line-2" v-bind:class="hmylfcFun(i,k+6)" v-for="(item,k) in 2" v-html="dx4Html(l.num4zh,k,l.miss)"></td>
            <td class="line-2" v-bind:class="hmylfcFun(i,k+8)" v-for="(item,k) in 2" v-html="dx5Html(l.num5zh,k,l.miss)"></td>
            <td style="width: 50px;" class="border-td"  v-html="fontColorFun(l.zh)"></td>
            <td class="line-6" v-bind:class="hmylfcFun(i,k+11)" v-for="(item,k) in 6" v-html="dxbHtml(l.zh_p,k,l.miss)"></td>
        </tr>
        <tr v-if="indexTime == 2">
            <td>
                {{dateTime}}<a style="color:deeppink;">{{resetIssue}}</a>
...
<script type="text/javascript" src="<?php echo $HttpTemplatePath; ?>51cp/static/web/js/cqssc/cqssc-trend<?php echo $pos_type; ?>_4.js?v=c167ceaa2357dd0f98caf9a7514f1ea5"></script>