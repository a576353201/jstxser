<div class="common-zs-table" style="position: relative;">
    <table>
        ...
        <tr v-for="(l,i) in data">
            ...
            <td class="border-td" v-text="l.sum_tail"></td>
            <td width="30px" class="line-10 b0" v-bind:class="hmylfcFun(i,k+2)" v-for="(item,k) in 10"  v-html="num1Html(l.sum_tail,k,l.miss)"></td>
            <td class="line-2" v-bind:class="hmylfcFun(i,k+12)" v-for="(item,k) in 2" v-html="dxHtml(l.sum_tail_dx,k,l.miss)"></td>
            <td class="line-2" v-bind:class="hmylfcFun(i,k+14)" v-for="(item,k) in 2" v-html="dsHtml(l.sum_tail_ds,k,l.miss)"></td>
            <td class="line-2" v-bind:class="hmylfcFun(i,k+16)" v-for="(item,k) in 2" v-html="zhHtml(l.sum_tail_zh,k,l.miss)"></td>
            <td class="line-3" v-bind:class="hmylfcFun(i,k+18)" v-for="(item,k) in 3" v-html="luHtml(l.sum_tail_012,k,l.miss)"></td>
            <td class="line-3" v-bind:class="hmylfcFun(i,k+21)" v-for="(item,k) in 3" v-html="spjHtml(l.sum_tail_spj,k,l.miss)"></td>
        </tr>
        <tr  v-if="indexTime == 2">
            <td>
                {{dateTime}}<a style="color:deeppink;">{{resetIssue}}</a>
        ...
        <tr>
            <td colspan="10" width="30px;">和尾</td>
            <td colspan="2">大小</td>
            <td colspan="2">单双</td>
            <td colspan="2">质合</td>
            <td colspan="3">012</td>
...
<script type="text/javascript" src="<?php echo $HttpTemplatePath; ?>51cp/static/web/js/cqssc/cqssc-trend1_3.js?v=c167ceaa2357dd0f98caf9a7514f1ea5"></script>