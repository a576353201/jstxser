<div class="common-zs-table" style="position: relative;">
    <table>
        ...
        <tr v-for="(l,i) in data">
            ...
            <td width="30px" class="line-10 b0" v-bind:class="hmylfcFun(i,k+1)" v-for="(item,k) in 10" v-bind:id="k == 0 && i == 0?'num':''" v-html="num1Html(l.max,k,l.miss)"></td>
            <td class="line-2" v-bind:class="hmylfcFun(i,k+11)" v-for="(item,k) in 2" v-html="dxHtml(l.max_dx,k,l.miss)"></td>
            <td class="line-2" v-bind:class="hmylfcFun(i,k+13)" v-for="(item,k) in 2" v-html="dsHtml(l.max_ds,k,l.miss)"></td>
            <td class="line-2" v-bind:class="hmylfcFun(i,k+15)" v-for="(item,k) in 2" v-html="zhHtml(l.max_zh,k,l.miss)"></td>
            <td class="line-3" v-bind:class="hmylfcFun(i,k+17)" v-for="(item,k) in 3" v-html="luHtml(l.max_012,k,l.miss)"></td>
            <td class="line-3" v-bind:class="hmylfcFun(i,k+20)" v-for="(item,k) in 3" v-html="spjHtml(l.max_spj,k,l.miss)"></td>
        </tr>
        <tr v-if="indexTime == 2">
            <td>
                {{dateTime}}<a style="color:deeppink;">{{resetIssue}}</a>
        ...
        <tr>
            <td colspan="10" width="30px;">最大号</td>
            <td colspan="2">大小</td>
            <td colspan="2">单双</td>
            <td colspan="2">质合</td>
            <td colspan="3">012</td>
