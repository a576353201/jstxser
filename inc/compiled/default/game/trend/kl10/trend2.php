<div class="common-zs-table" style="position: relative;">
    <table>
        ...
        <tr v-for="(l,i) in data">
            ...
            <td class="line-2" v-bind:class="hmylfcFun(i,k+10)" v-for="(item,k) in 2" v-html="dx6Html(l.num6dx,k,l.miss)"></td>
            <td class="line-2" v-bind:class="hmylfcFun(i,k+12)" v-for="(item,k) in 2" v-html="dx7Html(l.num7dx,k,l.miss)"></td>
            <td class="line-2" v-bind:class="hmylfcFun(i,k+14)" v-for="(item,k) in 2" v-html="dx8Html(l.num8dx,k,l.miss)"></td>



            <td class="line-9" v-bind:class="hmylfcFun(i,k+16)" v-for="(item,k) in 9" v-html="dxbHtml(l.dx_num,k,l.miss)"></td>
        </tr>
        <tr  v-if="indexTime == 2">
            <td>
                {{dateTime}}<a style="color:deeppink;">{{resetIssue}}</a>
...
<script>
    ...
    var fields = {
        ...
        num7dx:['大','小'],
        num8dx:['大','小'],
        dx_num:['0:8','1:7','2:6','3:5','4:4','5:3','6:2','7:1','8:0']
