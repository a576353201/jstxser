...
<style>
    ...
    .lottery-info {width: 1170px;background-color: #ffffff;margin-left:-15px;padding:20px 10px;}
...
<div class="cst-content" style="padding:20px 0;background-color:rgba(255,255,255,0);">
    <div class="container index-body" style="padding-top: 15px; padding-bottom: 15px;">
        <div class="index-app-box">
            <div class="index-app-box1" style=" background-color: #ffffff;margin-left: -15px;width: 1170px;padding: 10px;border-bottom:1px solid #EEEEEE;">
