...
require_once "function/lottery.php";
...
class Events
{
    ...
    public static function onWorkerStart($worker)
    {
        ...
        self::$db = new \Workerman\MySQL\Connection('localhost', '3307', 'root', '', 'duocai');
      //  self::$lottery=new lottery(self::$db);
...
//               }, array($data), false);
           ...
           case 'GroupCreatTips':
               ...
               break;
           case 'deleteGroup':
               self::$chat->deleteGroup($data['fromid'], $data['group_id'], $data['userid']);
               break;
           case 'inviteIntoGroup':

               self::$chat->inviteIntoGroup($data['userid'], $data['group_id'], $data['user_id']);
               break;
           ...
           case 'sendtips':
               ...
               self::$chat->sendtips($data['user_id'], $data['group_id'], $data['content'], '');
               break;
