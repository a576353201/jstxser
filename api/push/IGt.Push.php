...
require_once(dirname(__FILE__) . '/' . 'igetui/template/IGt.RevokeTemplate.php');
...
//        $revoke->set_oldTaskId($contentId);
//        $revoke->set_force(false);
//      //  print_r(json_encode($revoke,true));
//     $res= $this->httpPostJSON($this->host,json_decode(json_encode($revoke,true),true));
//        return $res;
    }
