...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="titlebg">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()" style="margin-left:3px;">
          ...
          <tr>
            ...
            <td width="10%" height="22" background="../style/images/content/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">二级栏目</span></div></td>

            <td width="10%" background="../style/images/content/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">三级栏目</span></div></td>
                    <td width="5%" background="../style/images/content/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">留言时间</span></div></td>
     ...
     <?php 
     $sql="select * from ".tname('message')." where type1='$_GET[menuid]' and uid='$userid' order by id desc";
     $num=20;
  ...
  <td height="20" bgcolor="#FFFFFF"><div align="center"><?php $type2=get_menu_byid($row['type2']);echo $type2['title'];?></div></td>
            <td bgcolor="#FFFFFF"><div align="center">
     <?php $type3=get_menu_byid($row['type3']);echo $type3['title'];?>
            </div></td>
                  <td bgcolor="#FFFFFF"><div align="center">
     <?php if($row['status']==1) echo "显示";if($row['status']==2) echo "草稿";?>
            </div></td>
             <td bgcolor="#FFFFFF"><div align="center">
     <?php echo date("Y-m-d H:i:s",$row['addtime']);?>
            ...
            <div align="center"><span class="STYLE4">
                  ...
                  <a href='add.php?id=<?php echo $row['id']?>&type=edit'><img src="../style/images/content/edt.gif" width="16" height="16" />查看并回复</a>&nbsp; &nbsp;
